    ...
    <section className="relative bg-dark pt-32 pb-16 md:pt-40 md:pb-20">
      <div className="mx-auto px-6 md:px-12 lg:px-[120px] text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          <a
            href="/contact"
            className="inline-flex items-center gap-2 px-6 py-3 bg-gold-dark text-white rounded-full font-medium hover:bg-gold transition-all duration-300 text-base"
          >
            Get in touch
          </a>
        </div>
